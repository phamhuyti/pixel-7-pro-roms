...
1. **Web installer (WebUSB)** — [`/pixel-7-pro/cai-dat/lineageos/web`](src/app/[device]/cai-dat/lineageos/web/page.tsx): unlock + nạp nightly (SHA256) + flash recovery images, rồi auto sideload zip (chờ bạn Format data / Apply from ADB trên recovery). Mirror Lineage không CORS nên tải qua link official rồi nạp file.
